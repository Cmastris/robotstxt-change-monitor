...
2. Locate the `example_config.py` file in the top-level directory and create a new `config.py` file in the same directory. Copy in the contents of `example_config.py` (this will be filled in properly later).
